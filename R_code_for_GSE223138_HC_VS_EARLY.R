...
cat("\n╔══════════════════════════════════════════════════════════╗\n")
cat("║   Complete scRNA-seq Pipeline — GSE223138              ║\n")
...
# ── NEW: MANUAL SAMPLE LABELS ──
# List ONLY the GSM IDs of the files you kept, and assign them exactly as you want.
# Format: "GSM_ID" = "Your_Label"
N_CORES       <- 10
...
CHOSEN_RES    <- 0.6    # look at results/clustering/01_umap_all_resolutions.pdf
MANUAL_LABELS <- c(
  "GSM6940192_16" = "Healthy_Control",
  "GSM6940193_17" = "Healthy_Control",
  "GSM6940194_19" = "parkinson_disease",
  "GSM6940195_20" = "parkinson_disease"
    # Add the rest of your kept samples here and delete my example GSM IDs.
)
